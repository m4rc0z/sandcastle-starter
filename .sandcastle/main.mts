...
await run({
  ...
  // The agent provider. Uses OpenCode with GitHub Copilot — no ANTHROPIC_API_KEY needed.
  // OpenCode reads auth from ~/.config/opencode/ (GitHub Copilot OAuth).
  agent: opencode("github-copilot/claude-sonnet-4-6"),
